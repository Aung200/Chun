...
$sql = "SELECT * FROM Product WHERE 1=1 AND isNew = 1";
...
<body>
  ...
  <div class="main_wrapper" style="padding: 30px 0px 50px 0px">
    <div class="container">
      ...
      <form method="GET" action="newarrivals.php" class="filter-container">
      ...
      <h1 style="text-align: center; margin-top: 0px">New Arrival Products</h1>
