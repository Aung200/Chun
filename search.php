...
// Store the search value in the session if it's posted
if (isset($_POST['search'])) {
  $_SESSION['search'] = $_POST['search'];
}

// Retrieve the search value from the session
...
<body>
  ...
  <div class="main_wrapper" style="padding: 30px 0px 50px 0px">
    <div class="container">
      ...
      <form method="GET" action="search.php" class="filter-container">
      ...
      <h1 style="text-align: center; margin-top: 0px">Search Product Named: <?php echo htmlspecialchars($search); ?></h1>
