...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($uploadOk == 0) {
        ...
        if (move_uploaded_file($_FILES['productImage']['tmp_name'], $targetFile)) {
            ...
            $sql = "INSERT INTO Product (Prodid, Name, Price, Type, Color, Description, qty, Discount, isNew, created_datetime, image_path) VALUES ('$gid', '$name', '$price', '$type', '$color', '$description', '$qty', '$discount', '$isnew', NOW(), '$targetFile')";
